#### Configuración simple de bloques par RADSEC
 ```
El archivo radsec permite la creación del modulo de seguridad para el protocolo Radius. Este módulo de seguridad consiste en que el canal de comunicación entre un servidor Radius Local y su servidor Federado se establezca a traves de un Tunel TP/SSL, reemplazando a la comunicación por default del Radius (UDP).
